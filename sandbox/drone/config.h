...
/*************************************************************************************************/
  ...
  bool led_state;
  #define LEDPIN_PINMODE             pinMode(LED_BUILTIN, OUTPUT); // use A1 instead of d13
  #define LEDPIN_TOGGLE              led_state=!led_state; // PINB |= 1<<5;     //switch LEDPIN state (digital PIN 13)
  #define LEDPIN_OFF                 led_state=false; digitalWrite(LED_BUILTIN, led_state); // PORTB &= ~(1<<5);
  #define LEDPIN_ON                  led_state=true; digitalWrite(LED_BUILTIN, led_state);    // was PORTB |= (1<<5);
