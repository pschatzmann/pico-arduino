...
{
	_size = size;
	// add one char to tpwerminate the string
...
void RingBufferESP::getStr(char * destination, unsigned int skipChars)
{
...
void RingBufferESP::getStrN(char * destination, unsigned int skipChars, unsigned int num)
{
	int len = ringBufP-ringBuf-skipChars;
